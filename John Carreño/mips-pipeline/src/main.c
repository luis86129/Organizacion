 ...
 *
 * Uso:
 *   ./mips_sim --imem vectors/s1_imem.bin
 *              [--dmem archivo.bin] [--regs archivo.bin]
 *              [--out-dmem archivo.bin] [--out-regs archivo.bin]
 *              [--max-cycles N] [--trace]
 *
 * Los tres .bin de entrada contienen palabras de 32 bits little-endian.
 * ===================================================================== */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
    printf("uso: %s --imem <archivo.bin> [opciones]\n", prog);
